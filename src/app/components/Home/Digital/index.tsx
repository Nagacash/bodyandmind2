    ...
    <section className='relative bg-cover bg-center overflow-hidden py-16'>
      <div className='container mx-auto max-w-7xl px-4'>
            ...
            <motion.div
              ...
              <p className='text-lg font-normal text-black mb-5 tracking-widest uppercase mt-5'>
              Ihr Fitness Trainer
              </p>
              <h2 className={`text-white mb-8 leading-tight text-center lg:w-full ${bebasNeue.className}`}>
