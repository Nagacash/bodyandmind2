...
|----|------|-------|--------|--------|----------|--------|
| G01 | Indexation | Duplicate conflicting canonical on all subpages (layout `<head>` + page metadata) | Critical | Low | **Fix first** | **fixed** |
| G02 | Crawlability | /about-me in sitemap but not internally linked | High | Low | **Fix first** | **fixed** |
| G03 | Indexation | /documentation template page indexed | High | Low | **Fix first** | **fixed** |
| G04 | Internal links | Mobile nav → /imprint /privacy (placeholder, noindex) | High | Low | **Fix first** | **fixed** |
...
| G12 | Answer-first | Wingwave query had no dedicated answer block | Medium | Low | Fix | **fixed** |
